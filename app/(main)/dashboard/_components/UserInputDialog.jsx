  ...
  return (
    ...
    <DialogContent>
        ...
        <DialogDescription asChild>
            <div className='mt-3'>
                <h2 className='text-black font-medium'>Enter a topic to master your skills in {coachingOption.name}</h2>
                <Textarea placeholder="Enter your topic here..." className='mt-2'
                onChange={(e)=>setTopic(e.target.value)}
                />
                <h2 className='text-black mt-5 font-medium'>Select your coaching expert</h2>
                ...
                <div className='grid grid-cols-3 md:grid-cols-5 gap-6 mt-3'>
                  {CoachingExpert.map((expert, index)=>(
                    ...
                    hover:scale-105 transition-all cursor-pointer p-1 border-indigo-400
                ...
                <div className='flex gap-5 justify-end mt-5'>
                  ...
                  <Button disabled={(!topic || !selectedExpert || loading)} className='bg-[#5434dc] hover:bg-[#432bb5] active:bg-[#5434dc]' onClick={OnClickNext}>
